Shader "Universal Render Pipeline/OpenBlocksInsertEffectLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment InsertEffectPassFragment
            ...
            InsertEffectVaryings OpenBlocksLitPassVertex(InsertEffectAttributes input)
            {
                ...
                InsertEffectVaryings output;
                output.varyings = LitPassVertex(input.attributes);
                output.color = input.color;
                return output;
            }

            void InsertEffectPassFragment(InsertEffectVaryings input, out half4 outColor : SV_Target0
