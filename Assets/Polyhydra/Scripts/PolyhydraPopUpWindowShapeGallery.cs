...
namespace TiltBrush
{
    ...
    public class PolyhydraPopUpWindowShapeGallery : MonoBehaviour
    {
        ...
        public void Init(GameObject rParent, string sText)
        {
        ...
        public void UpdateUIComponents(Ray rCastRay, bool inputValid, Collider parentCollider)
        {
