...
Shader "Mogwai/DirectionalPaperUniform"
{
	Properties
	{
	...
	SubShader
	{
      ...
      float _OverrideAmount;
        ...
        float NDotV = dot(fragment.normal,  V);
        ennoisenedNormal = lerp(mul(unity_ObjectToWorld, fragment.normal), ennoisenedNormal, smoothstep(0.1, 0.4, NDotV));
