...
namespace com.google.apps.peltzer.client.model.export
{
    ...
    public class PeltzerFile
    {
        ...
        /// older Poly versions.
        /// </summary>
        private const int LEGACY_FILE_FORMAT_VERSION = 1;
        private const int CUSTOM_COLORS_FILE_FORMAT_VERSION = 2;
        ...
        public PeltzerFile(PolySerializer serializer)
        {
            ...
            AssertOrThrow.True(
              formatVersion >= LEGACY_FILE_FORMAT_VERSION && formatVersion <= CUSTOM_COLORS_FILE_FORMAT_VERSION,
              $"Wrong file format version: {formatVersion}, expected {LEGACY_FILE_FORMAT_VERSION}-" +
              $"{CUSTOM_COLORS_FILE_FORMAT_VERSION}");
