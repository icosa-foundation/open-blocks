...
namespace com.google.apps.peltzer.client.model.core
{
    ...
    public class Face
    {
        ...
        public Face Clone()
        {
            ...
            // The vertex position/normal/color caches are deliberately not copied: they are all lazily rebuilt
            // on demand (see GetMeshSpaceVertices, GetRenderNormals and GetColors), and skipping them keeps
