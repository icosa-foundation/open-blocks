...
namespace com.google.apps.peltzer.client.model.controller
{
    ...
    /// <summary>
    ///   SelectableMenuItem that can be attached to the PolyMenu to toggle between Models and Collections.
    /// </summary>
    public class SelectableContentTypeToggleMenuItem : PolyMenuButton
    {
        public override void ApplyMenuOptions(PeltzerMain main)
        {
            if (isActive)
            {
                main.GetPolyMenuMain().ToggleContentType();
