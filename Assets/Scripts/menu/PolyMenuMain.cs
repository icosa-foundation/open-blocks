...
namespace com.google.apps.peltzer.client.menu
{
    public class PolyMenuMain : MonoBehaviour
    {
        ...
        // The type of content being viewed (models or collections)
        public enum ContentType { MODELS, COLLECTIONS }
        ...
        // Track which content type (models or collections) is being viewed for each creation type
        private ContentType yourContentType = ContentType.MODELS;
        private ContentType featuredContentType = ContentType.MODELS;
        private ContentType likedContentType = ContentType.MODELS;
        ...
        private GameObject yourOrLocalModelsMenuSpacer;
        ...
        public void Setup(ZandriaCreationsManager creationsManager, PaletteController paletteController)
        {
            ...
            yourOrLocalModelsMenuSpacer = detailsMenu.transform.Find("Buttons/bg-space").gameObject;
        ...
        public void SwitchToLocalModelsSection()
        {
            menuIndex = 6;
        }
        ...
        public ContentType CurrentContentType()
        {
            switch (CurrentCreationType())
            {
                ...
                case CreationType.LOCAL:
                    return ContentType.MODELS; // Local only has models
                default:
        ...
        public void ToggleContentType()
        {
            switch (CurrentCreationType())
            {
                case CreationType.YOUR:
                    ...
                    break;
                case CreationType.FEATURED:
                    featuredContentType = featuredContentType == ContentType.MODELS ? ContentType.COLLECTIONS : ContentType.MODELS;
                    break;
                case CreationType.LIKED:
                    likedContentType = likedContentType == ContentType.MODELS ? ContentType.COLLECTIONS : ContentType.MODELS;
                    break;
                case CreationType.LOCAL:
                    // No toggle for local
                    return;
