...
{
    /// <summary>
    /// This class exists primarily to hold the static method for RenderFaces when PAINT is set. It may be possible to
    ...
    public class FacePaintStyle
    {
        ...
        {
            HashSet<FaceKey> keys = faceHighlights.getKeysForStyle((int)FaceStyles.PAINT);
