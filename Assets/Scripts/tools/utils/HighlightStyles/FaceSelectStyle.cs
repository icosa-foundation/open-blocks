...
{
    /// <summary>
    /// This class exists primarily to hold the static method for RenderFaces when EXTRUDE is set. It may be possible to
    /// consolidate this with the other Face*Style classes in the future.
    /// </summary>
    public class FaceSelectStyle
    {
        ...
        {
            HashSet<FaceKey> keys = faceHighlights.getKeysForStyle((int)FaceStyles.FACE_SELECT);
