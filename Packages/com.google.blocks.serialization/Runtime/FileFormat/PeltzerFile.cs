...
namespace com.google.blocks.serialization
{
    ...
    public class PeltzerFile
    {
        ...
        /// in save (optional feature).</param>
        /// <param name="recommendedRotation">The recommended rotation if includeDisplayRotation is true.</param>
        public void Serialize(PolySerializer serializer, bool includeDisplayRotation = false, float recommendedRotation = 0f)
        {
            ...
            // Write the angle of rotation of the model (optional feature).
    ...
    // Basic metadata about a Peltzer/Blocks file.
    ...
    // A material used in a Peltzer/Blocks file.
